...
class Game:
    def __init__(self, width=900, height=500):
        ...
        self.assets = {
            ...
            'tela_jogo': pygame.transform.scale(pygame.image.load('assets/telainicio.png'), (width, height)),
            ...
            'moana': pygame.transform.scale(pygame.image.load('assets/moana_pig.png'), (80, 85)),
            'dumbo': pygame.transform.scale(pygame.image.load('assets/dumbo.png'), (80, 80)),
        ...
        self.personagens_adicionais = [
            ...
            Personagem(self.assets['dumbo'], (675, 350)),
    ...
    def processar_eventos(self):
        ...
        for fantasma in [self.fantasma, self.fantasma2]:
            fantasma.gravidade(self.personagem)  # Aplicar gravidade no personagem
